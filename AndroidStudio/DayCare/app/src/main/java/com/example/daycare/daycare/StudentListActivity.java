...
//        getWindow().addFlags(Window);
    ...
    public void onSectionAttached(int number) {
        String[] navigation_titles = getResources().getStringArray(R.array.navigation_drawer);
        mTitle = navigation_titles[number-1];
//        switch (number) {
//            case 1:
//                navigation_titles[1];
//                break;
...
//        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(rootView.getContext(), R.layout.simple_list_item, students);
        ...
        public void onAttach(Activity activity) {
            ...
            ((StudentListActivity) activity).onSectionAttached(
