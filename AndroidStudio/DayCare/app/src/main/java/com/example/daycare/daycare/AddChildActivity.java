...
public class AddChildActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		Button submitButton = (Button) findViewById(R.id.cSubmitButton);
	...
	private class GetParentID extends AsyncTask<String, Void, String>
	{
	...
	private class GetChildInfoBySSN extends AsyncTask<String, Void, String>
	{
