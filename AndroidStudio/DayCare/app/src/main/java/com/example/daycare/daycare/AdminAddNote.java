...
public class AdminAddNote extends Activity
{
	...
	void childSearchAsync(String cSSN)
	{
	...
	void storeIDs(int whichTeacher)
	{
		try
		{
		...
		public Dialog onCreateDialog(Bundle savedInstanceState)
		{
			...
			builder.setTitle("Child Search")
				   ...
				   .setPositiveButton("Search", new DialogInterface.OnClickListener()
				   {
					   ...
					   public void onClick(DialogInterface dialogInterface, int i)
					   {
						   ((AdminAddNote) getActivity()).childSearchAsync(cSSN.getText().toString());
	...
	private class GetChildInfo extends AsyncTask<String, Void, String>
	{
		...
		protected void onPostExecute(String message)
		{
			...
			if (message != null)
			{
				try
				{
					...
					JSONObject cInfo = new JSONObject(cArray.getJSONObject(0).toString());
